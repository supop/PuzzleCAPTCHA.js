  ...
  function PuzzleCaptcha({
    ...
    return (
      React.createElement(Wrapper, null,
        React.createElement(Box, { boxWidth: imgSize.width - 1, boxHeight: imgSize.height - 1 },
          React.createElement(BoxBG, null,
            React.createElement(BoxBGImage, {
              ref: imgRef,
              src: imageURL,
              onLoad: handleLoad,
              imgw: width,
          ...
          loaded && pieces.map((p) => (
            React.createElement(BoxItem, {
              ...
              React.createElement(CropImage, Object.assign({ src: imageURL, alt: '' }, cropProps))
            )
          ))
        ),
        React.createElement(Answer, { itemW: itemW, itemH: itemH, mt: imgSize.height / 2 - itemH / 2 },
          loaded && React.createElement(CropImage, Object.assign({ src: imageURL, alt: '' }, cropProps))
        )
      )
    );
  }
